...
function FooterComponent() {
  ...
  return (
    <footer className="footer-container">
      ...
      <div className="footer-column">
        <h3>Contact Us</h3>
        <p><a href={mapLink} target="_blank" rel="noopener noreferrer">7753 Lake Worth Rd Lake Worth, FL 33467</a></p>
        <p><a href="tel:+15616608650">(561) 660-8650</a></p>
        <p><a href="mailto:support@pandmpharmacy.com">support@pandmpharmacy.com</a></p>
      </div>
